...
def naked_twins(values):
    ...
    for cell_key in values.keys():
        ...
        for unit in units[cell_key]:
            for cell_key_two in unit:
                if cell_key_two == cell_key:
                    continue

                if values[cell_key_two] == value:
                    for unit_ in unit:
                        if unit_ != cell_key and unit_ != cell_key_two:
                            for digit in value:
                                assign_value(values, unit_, values[unit_].replace(digit, ''))
